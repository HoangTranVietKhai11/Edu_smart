...
const { getExams, getExam, createExam, updateExam, deleteExam, addQuestion, updateQuestion, deleteQuestion, submitExam, getExamResults, extractQuestionsFromFile, extractQuestionsOnly } = require('../controllers/examController');
...
router.post('/extract', protect, authorize('teacher'), uploadDocument, extractQuestionsOnly);
